    ...
    def get_movies():
        ...
        def create_actor(playload):  # CUSTOMER ID NEEDS TO BE PASSED HERE,
            try:
                ...
                new_actor = Actors(name=request.json.get('name'), age=request.json.get('age'), gender=request.json.get('gender'))
        ...
        def create_movies(playload):  # CUSTOMER ID NEEDS TO BE PASSED HERE,
            try:
                ...
                new_movie = Movies(title=request.json.get('title'), release_date= request.json.get('release_date'))
